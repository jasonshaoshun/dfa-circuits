...
for pair in "${MODEL_PAIRS[@]}"; do
  ...
  for mla in "${METHODS_LEVEL_ABLATIONS[@]}"; do
    ...
    # # Include source-model gold evaluations too, so smallest source-only
    # # models in each family are available for size-scaling figures.
    # extra_gold_model="${source_model}"
